...
#ifndef LMMS_PLUGINS_MELODYEDITOR_ABSTRACTPARSER_CPP
#define LMMS_PLUGINS_MELODYEDITOR_ABSTRACTPARSER_CPP
...
#endif // LMMS_PLUGINS_MELODYEDITOR_ABSTRACTPARSER_CPP